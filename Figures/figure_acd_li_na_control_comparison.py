...
yps.plot_acd("",na_linear_optics_list,spec_na,length_nm/197.3,title = "NSCO",ax = axes[1],**kwargs_base)
axes[1].plot(ncso_smm_spec,ncso_smm_cd_mdeg,color = "red",linestyle = "--")
axes[1].plot(ncso_smm_spec,ncso_rev_smm_cd_mdeg,color = "blue",linestyle = "--")
yps.plot_acd("",control_linear_optics_list,spec_control,length_nm/197.3,title = "Control",ax = axes[2],**kwargs_base)
