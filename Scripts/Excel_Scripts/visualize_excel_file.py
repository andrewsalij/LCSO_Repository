...
mueller_file = "Ka1_UnNMMt.xlsx"
full_filepath = os.sep.join((setup.BASE_DIR,mueller_subdir,mueller_file))

mueller_dataarray = base_scripts.parse_excel.mueller_excel_to_dataarray(full_filepath)
...
mueller.mueller_matrix_grid_plot(wavelength_array,normed_mueller_array)
